...
```{r setup,result = "hide",warning= F,message= F}
library(xml2)
library(magrittr)
library(ggplot2)
library(dplyr)
...
```{r ggplot1, fig.height = 7, fig.width = 12}
#累計進出曾經達到250
...
```{r ggplot2, fig.height = 7, fig.width = 12}
...
```{r ggplot3, fig.height = 7, fig.width = 12}
#挑出幾間外資,幾間國內的券商
